...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------|
   * | Ctrl |  Alt |      |      |Lower |    Space    |Raise |  Up  | Down | Left |Right |
   * `-----------------------------------------------------------------------------------'
   */
  [_GAME] = {
    ...
    {KC_LCTL, KC_LGUI, KC_NO, KC_NO, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_UP, KC_DOWN, KC_LEFT,   KC_RGHT}
  },
...
[_LOWER] = {
  ...
  {M_CTL_SFT_C,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_LBRC, KC_RBRC, KC_EQL, KC_MINS,  KC_BSLS},
...
[_RAISE] = {
  ...
  {KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______},
  {_______,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_LCBR, KC_RCBR, KC_PLUS, KC_UNDS, KC_PIPE},
 ...
 * |      | Reset|      |      |      |      |      |      |      |      |      |  Del |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |      |      |Aud on|AudOff|AGnorm|AGswap|      |Colemk|Dvorak|      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
